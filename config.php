...
define('MSG_HELP', "❓ Такой команды нет. <br> 📒 Список команд: <br> !пидор 'имя' <br> !пидорас 'имя'"); //Сообщение если команда введена не правильно или не введена вообще
define('MSG_WELCOME', "Привет, добро пожаловать в пидорского бота команды вот, сайт вот");
